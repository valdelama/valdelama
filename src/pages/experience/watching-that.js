...
export default ({ data }) => (
  <Layout>
    <BodyCopy>
      ...
      />
      <p>
        As head of design at Watching That, a data analytics platform for video
        media, I am responsible for finding ways for our customers to navigate
        and interpret large sets of complex data so that they can optimize their
        video advertising technology stack. The role combines data exploration,
        UX design, data visualisation design, marketing design, and front-end
      ...
      <div className={styles.expBlock2}>
        <SectionCopy title="Content Performance">
          <p>
            ...
            success. At the same it enables them to spot opportunities where
            engaging content is not receiving the sort of exposure it
